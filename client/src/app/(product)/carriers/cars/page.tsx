...
export default function Cars() {
    const truckJSON = [
        ...
        { id: 2, CarNumber: "HT1089", status: 0, country: "Slovakian", Car: 1 },
    ];
                    ...
                    <div className={styles.FilterButtons}>
                        <div className={styles.FilterButtonTrack}>
                            {ButtonsJSON.map((car, index) => (
                                <a key={index} className={styles.FilterButton}>
                                    <p>{car.TypeCar}</p>
                                </a>
                            ))}
                        </div>
                        <a className={styles.FilterButtonAll}>
                            <p>ALL</p>
                        </a>
                    </div>
                    <div className={styles.FilterInput}>
                        ...
                        >
                            <g>
                                <path
                                    className="st0"
                                    d="M496.872,423.839l-85.357-85.358c-4.76,7.322-9.901,14.378-15.392,21.142l-31.484-31.485
                                ...
                                <div className={styles.TruckHeader}>
                                    <div className={styles.TruckTitle}>
                                        <div className={styles.TruckTitleOne}>
                                            ...
                                            <span>{countryToEmoji[truck.country] || ""}</span>
                                        </div>
